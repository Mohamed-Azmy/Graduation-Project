...
import { findByEmail,addDoctor , findAllDoctors, updateDoctor,deleteDoctor,findById,addCourse,getAllCoursesFromDB,deleteCourse, findByCourse, findDoctorById} from "./DBquery.js"
...
export const addCourseByAdmin = asyncHandler(async(req,res,next)=>{
    const {courseName, courseCode , doctorId, level, semster } = req.body;
    ...
    const newCourse = await addCourse({courseName,courseCode , doctorId, level, semster });
